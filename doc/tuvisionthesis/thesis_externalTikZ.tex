...
\begin{enumerate}
	\item Be pose that is reachable by joints and obey joint constraints.
...
\todo{equations?}
In either of the approaches, the final output is joint angles. Then they are used to verify whether the robot is in a stable stand-up posture.
