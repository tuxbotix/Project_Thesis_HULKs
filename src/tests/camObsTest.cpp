...
//    Camera camName = sensorName == SENSOR_NAME::TOP_CAMERA? Camera::TOP:
//    Camera::BOTTOM;

//    std::vector<float> jointAngles = {3.141590e-01, 1.396260e-01,
//    1.570800e+00, 2.000000e-01, 1.570800e+00, -8.726650e-03, 0.000000e+00,
//                                      0.000000e+00, 4.345030e-02,
//                                      3.923680e-01, -1.020720e+00,
//                                      1.700120e+00, -5.993040e-01,
//                                      -3.939770e-01,
//                                      4.345030e-02, 1.251520e-01,
//                                      -1.250350e+00, 9.796810e-01,
//                                      3.451760e-01, -1.220670e-01,
//                                      1.570800e+00,
//                                      -2.000000e-01, -1.570800e+00,
//                                      8.726650e-03, 0.000000e+00,
//                                      0.000000e+00}; // stat 1;

//    CameraObservationModel cObs(cfg.imSize, cfg.fc, cfg.cc, cfg.fov,
//                                cfg.dimensionExtremum,
...
//        cObs.naoJointSensorModel.robotToPixelMulti(camName, gridSet);
...
//        }
//        bool observed;
//        Vector3f sensitivity = cObs.getSensitivityForJointForCamera(joint,
//        jointAngles, sf, grid, VecVector2<float>(0), camName, observed);
...
void weirdPointTest2(const ObservationModelConfig cfg) {
  /*
  dimension Limit violation!!! j->11 0 0.628319 0.244346 1.5708 0.2 1.5708
-0.00872665 0 0 0.0197297 0.530006 -0.18356 0.940766 -0.713433 -0.373344
0.0197297 0.231953 -0.15904 0.857232 -0.661697 -0.0743088 1.5708 -0.2 -1.5708
0.00872665 0 0 stat 1
...
*/
  ...
  std::vector<float> jointAngles = {
      6.283190e-01,  3.839720e-01,  1.570800e+00,  2.000000e-01,  1.570800e+00,
      -8.726650e-03, 0.000000e+00,  0.000000e+00,  -8.133260e-02, 2.935800e-01,
      -1.429230e+00, 1.255460e+00,  1.528070e-02,  -3.516450e-01, -8.133260e-02,
      -5.249380e-04, -1.471790e+00, 9.030850e-01,  4.139150e-01,  -4.027070e-02,
      1.570800e+00,  -2.000000e-01, -1.570800e+00, 8.726650e-03,  0.000000e+00,
      0.000000e+00};
  ...
  std::vector<PoseSensitivity<Vector3f>> senses =
      cObs.getSensitivities(jointAngles, sf, {sensorName});
...
void weirdPointTest2ObsProvider(const ObservationModelConfig cfg) {
  ...
  std::vector<PoseSensitivity<Vector3f>> senses =
      obs.getSensitivities(jointAngles, sf);
...
int main(int argc, char *argv[]) {
  ...
  const ObservationModelConfig cfg = {
      imSize, fc, cc, fov, {SENSOR_NAME::BOTTOM_CAMERA}, 1000, 25, 0.05};
  ...
  // // 'x' is vector of length 'n' containing the initial values for the
  // parameters.
  // // The parameters 'x' are also referred to as the 'inputs' in the context
  // of LM optimization.
  // // The LM optimization inputs should not be confused with the x input
  // values.
